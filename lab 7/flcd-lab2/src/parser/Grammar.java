...
//    public String getNextProduction(String production, String nonTerminal) {
...
//        List<List<String>> allProductions = getNonTerminalProductions(List.of(nonTerminal));
...
//        System.out.println("5 " + production + "      " + nonTerminal);
//        List<List<String>> nonTerminalProductions = new ArrayList<>(this.getNonTerminalProductions(List.of(nonTerminal)));
//        System.out.println("1 " + nonTerminalProductions);
//        for (int i = 0; i < nonTerminalProductions.size(); i++) {
//            System.out.println("2 " + nonTerminalProductions.get(i));
//            if (production.equals(nonTerminalProductions.get(i))  && i < nonTerminalProductions.size() - 1) {
